        ...
        for (int h = 0; h <= 9; h++)  { //Outside for loop used for performing code for all 9 cycles, h as cycle counter
            ...
            for(int tnum = 0; tnum <= runningtrucks; tnum++)
            {
                ...
                while(current[tnum] != start[tnum])
                {
                    ...
                    if (trucktimehours[tnum] < 10) {
                    if (h == 0) cy1W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 1) cy2W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 2) cy3W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 3) cy4W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 4) cy5W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 5) cy6W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 6) cy7W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 7) cy8W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 8) cy9W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 9) cy10W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately 0" + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    }
                    else {
                        if (h == 0) cy1W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 1) cy2W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 2) cy3W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 3) cy4W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 4) cy5W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 5) cy6W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 6) cy7W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 7) cy8W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 8) cy9W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    if (h == 9) cy10W.println("Truck " + (tnum + 1) + " travelled " + minimum + " feet to house at: street " + locations[start[tnum]].getStreet() + ", ave " + locations[start[tnum]].getAve() + ", house " + locations[start[tnum]].getHouseLetter() + " at approximately " + (trucktimehours[tnum]) + ":" + (((int)trucktime[tnum]%3600)/60) + ":" + (((int)(trucktime[tnum]%3600)%60)) + " Military Time");
                    }
